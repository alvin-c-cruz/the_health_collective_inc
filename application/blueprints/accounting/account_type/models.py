...
class AccountType(db.Model):
    ...
    account_class_id = db.Column(
        db.Integer, db.ForeignKey("account_class.id"), nullable=False
    )
    account_class = db.relationship(
        "AccountClass", backref="account_class_details", lazy=True
    )
