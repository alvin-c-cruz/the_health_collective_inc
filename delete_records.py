...
Usage: python delete_records.py
"""
...
def delete_all_records():
    ...
    try:
        ...
        print(f"  ✓ Deleted {count:,} customer records")
        ...
        if sum(final_counts.values()) == 0:
            ...
            print("\n✗ WARNING: Some records remain. Check for foreign key issues.")
