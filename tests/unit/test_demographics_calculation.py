...
class TestDemographicsCalculation:
    ...
    def test_demographics_groups_by_product_type(self, app, db, client):
        ...
        with app.app_context():
            ...
            # Create products
            prod_dialysis1 = ProductFactory(
                product_name="HD Session", product_type=pt_dialysis
            )
            prod_dialysis2 = ProductFactory(
                product_name="PD Session", product_type=pt_dialysis
            )
    ...
    def test_demographics_excludes_non_billable_items(self, app, db, client):
        ...
        with app.app_context():
            ...
            prod_medicine = ProductFactory(
                product_name="Medicine", product_type=pt_dialysis
            )
            db.flush()
            ...
            transaction = create_complete_transaction(
                ...
                details=[
                    {
                        "product": prod_session,
                        "amount": 5000,
                        "discount": 0,
                        "billable": True,
                    },
                    {
                        "product": prod_medicine,
                        "amount": 2000,
                        "discount": 0,
                        "billable": False,
                    },
